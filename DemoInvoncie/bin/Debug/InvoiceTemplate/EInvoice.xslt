...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					#lineTable tr:not(:first-child) td {
					font-size: 12px;
					}
					...
					#budgetContainerTable > tbody > tr > td:last-child {
					font-size:12px;
					color:#000;
					}
					...
					.bankInfo {border-collapse: collapse;border:1px solid #ccc;padding:3px;width:800px; margin-top:10px;}
					.bankInfo td, .bankInfo th {text-align:left; border: 1px solid #ccc;padding:3px}
					.bankInfo tr:first-child th {border-top: 0;}
					.bankInfo tr:last-child td {border-bottom: 0;}
					.bankInfo tr td:first-child,.bankInfo tr th:first-child {border-left: 0;}
					.bankInfo tr td:last-child,.bankInfo tr th:last-child {border-right: 0;}
				</style>
			...
			<body
				...
				<xsl:for-each select="$XML">
					<table cellspacing="0px" width="800"
						cellpadding="0px">
						<tbody>
							<tr valign="top">
								...
								<!--<td style="text-align:center; vertical-align:middle">
									<img width="250" style="margin-right: 50px" src=""/>
								</td>-->
								
								<td style="width: 80%;" valign="middle">
									<table align="start" style="margin-right: 50px" border="0">
										<tbody>
											<tr align="left">
											...
											<xsl:if
												test="//n1:Invoice/cac:AccountingSupplierParty/cac:Party/cbc:WebsiteURI or //n1:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:ElectronicMail">
												<tr align="left">
													<xsl:for-each select="n1:Invoice/cac:AccountingSupplierParty/cac:Party">
														<td align="left">
											...
											<tr align="left">
												<td>
													<xsl:for-each select="n1:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID = 'VKN' or @schemeID = 'TCKN']">
														<b>
											...
											<xsl:for-each select="n1:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID != 'VKN' and @schemeID != 'TCKN']">
												<tr align="left">
													<td>
														<b>
															<xsl:value-of select="./@schemeID"/>
								...
								<td align="right">
									...
									<div id="qrcode" style="wdth: 140px; height: 140px;"></div>
									<script type="text/javascript">
						...
						<tbody>
							<tr style="height:118px; " valign="top">
								...
								<td width="20%" align="center" valign="top">
									<!--Hazine ve Maliye Bakanlığı Logo-->
									<img style="width:91px;" align="middle" alt="Hazine ve Maliye Bakanlığı Logo"
								...
								<td width="40%" align="center" valign="top" colspan="2">
							...
							<tr align="left">
								<td align="left" valign="top" id="ettnTable">
									<div class="hr" style="margin-top:2px;margin-bottom:8px"></div>
									<span style="font-weight:bold; ">
						...
						<table id="lineTable" width="800px">
							<tbody>
								<tr>
									...
									<xsl:if test="//n1:Invoice/cbc:ProfileID='HKS' and (//n1:Invoice/cbc:InvoiceTypeCode='SATIS' or //n1:Invoice/cbc:InvoiceTypeCode='KOMISYONCU')">
										<th>
				...
				<div style="width:800px" >
					<center>
						<div  style="width:auto; margin:10px 0px;">
							Bu fatura <a target="_blank" style="font-weight:bold text-decoration: none; color: #091f2d;" href="https://nilvera.com">
								<b>
									<u>Nilvera</u>
								</b>
	...
	<xsl:template match="//n1:Invoice/cac:InvoiceLine">
		<tr>
			...
			<xsl:if test="//n1:Invoice/cbc:InvoiceTypeCode='OZELMATRAH'">
				<td>
					<xsl:for-each select="./cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode='0015']/cac:TaxCategory/cbc:TaxExemptionReasonCode">
						<xsl:apply-templates />
					</xsl:for-each>
				</td>
				<xsl:choose>
					<xsl:when test="./cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode='0015']/cac:TaxCategory/cbc:TaxExemptionReasonCode">
						<td>
							<xsl:for-each select="./cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode='0015']/cbc:TaxableAmount">
								<xsl:call-template name="Curr_Type" />
							</xsl:for-each>
						</td>
					</xsl:when>
	...
	<xsl:template name='Party_Other'>
		...
		<xsl:if test="cac:Contact/cbc:ElectronicMail or cbc:WebsiteURI">
			<tr align="left">
				<td>
		...
		<xsl:if test="$PartyType!='TAXFREE' and $PartyType!='EXPORT'">
			<tr align="left">
				<td>
					<xsl:for-each select="cac:PartyIdentification/cbc:ID[@schemeID = 'VKN' or @schemeID = 'TCKN']">
						<b>
							<xsl:value-of select="./@schemeID"/>
						</b>
						<b>
			...
			<xsl:for-each select="cac:PartyIdentification/cbc:ID[@schemeID != 'VKN' and @schemeID != 'TCKN']">
				<tr align="left">
					<td>
						<b>
							<xsl:value-of select="./@schemeID"/>
